...
const getUploadSignedUrlS3 = async (filename: DocumentToCreate['filename']): Promise<{url: string, documentId: string}> => {
...
const uploadDocument = async (file: File): Promise<{valid: true, documentId: string, error?: never} | {valid: false, error: string, documentId?: never}> => {
