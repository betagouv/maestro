...
const girpaReferences: Record<string, SSD2Id> = {
  ...
  'clodinafop according reg.': 'RF-0097-001-PPP',
  ...
  spinosad: 'RF-00012333-PAR',
  'spinosad (sum spinosyns A and D) ': 'RF-0393-001-PPP',
  ...
  'chlorpyrifos-methyl (sum)': 'RF-00007588-PAR',
  ...
  "o,p'-TDE (DDD)": 'RF-0119-005-PPP',
  "o,p'-DDE": 'RF-0119-007-PPP',
  ...
  'trinexapac according reg.': 'RF-00007587-PAR',
