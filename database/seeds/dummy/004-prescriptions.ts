...
exports.seed = async function () {
  ...
  await Prescriptions().insert([
    ...
    ...genPrescriptions(validatedSurveyProgrammingPlan.id,'Avoine', oneOf(SampleStageList), [5,8,5,4,0,8,3,0,4,6,6,4,0,0,0,0,0,0]),
    ...
    ...genPrescriptions(validatedSurveyProgrammingPlan.id,'Choux-fleurs', oneOf(SampleStageList), [2,0,13,0,0,7,0,6,5,0,0,3,0,0,0,0,0,0]),
    ...
    ...genPrescriptions(validatedSurveyProgrammingPlan.id,'Lentilles sèches', oneOf(SampleStageList), [9,5,0,5,0,6,0,0,6,5,2,0,0,0,0,0,0,0]),
    ...
    ...genPrescriptions(validatedSurveyProgrammingPlan.id,'Soja', oneOf(SampleStageList), [7,8,0,4,0,6,0,0,2,0,11,12,0,0,0,0,0,0]),
