...
export const MatrixList: Record<MatrixKind, Matrix[]> = {
  ...
  A042P: Matrix.extract(['A042Q', 'A042R', 'A042S', 'A042T', 'A042V', 'A042X'])
    .options,
  A042Y: Matrix.extract(['A042Z', 'A043A', 'A043B', 'A043C', 'A043D']).options,
  A0EQE: Matrix.extract([
    'A043Q',
    'A043R',
    'A043S',
    'A043T',
