...
import { useFindCompaniesQuery } from '../../../services/company.service';
...
interface Props {
  ...
  onChangeSlaughterhouseSampleCounts: (
    value: SlaughterhouseSampleCounts
  ) => void;
}

const LocalPrescriptionSlaughterhouseDistribution = ({
  ...
  const { data: companies } = useFindCompaniesQuery({
    kind: 'Slaughterhouse',
