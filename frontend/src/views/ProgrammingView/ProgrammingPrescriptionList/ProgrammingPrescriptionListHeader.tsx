...
const ProgrammingPrescriptionListHeader = ({
  ...
  const { hasRegionalView, hasDepartmentalView, hasUserPermission, userRole } =
    useAuthentication();
      ...
      <div className="prescription-list-header__filters">
        {!isSamplerView &&
          filterToggle(
            ...
            'Filtrer les lignes avec répartition à réaliser',
        ...
        {hasUserPermission('updatePrescriptionLaboratories') &&
          ...
          filterToggle(
            ...
            'Filtrer les lignes avec laboratoire à attribuer',
        ...
        {filterToggle(
          'withNovelty',
          'Nouveautés',
          'Filtrer les lignes présentant des nouveautés',
